...
import { Pause, Play, Radio, Users, Volume2 } from "lucide-react";
...
import {
  ...
  useStartListenerSession,
  useStopListenerSession,
...
export default function RadioPlayer({ onDJAccessClick }: RadioPlayerProps) {
  ...
  const getTextGlowStyle = (baseIntensity = 1) => {
    if (!audioData.isActive) return {};

    const intensity =
      baseIntensity * (8 + audioData.bass * 12 + audioData.bassKick * 8);
              ...
              <div className="relative z-10 space-y-4 sm:space-y-6">
                  ...
                  >
                    ...
                    <SelectContent className="bg-black/95 border-neon-cyan/50">
                      {playlists.map((playlist) => (
                        ...
                        >
                          <span className="text-glow-static">
                            {playlist.id}
                          </span>
                        </SelectItem>
                      ))}
                ...
                <div className="flex items-center justify-between p-2.5 sm:p-3 rounded-lg bg-black/40 border border-neon-cyan/30">
                  <div className="flex items-center gap-2">
                    ...
                    <Label
                      htmlFor="volume-norm"
                      className="text-xs sm:text-sm font-mono text-neon-cyan cursor-pointer text-shimmer"
                    >
                ...
                {currentTrack && (
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex items-center gap-2 sm:gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p
                          ...
                          style={
                            audioData.isActive ? getTextGlowStyle(0.9) : {}
                          }
                        >
                          {currentTrack.artist}
                        </p>
                    ...
                    <div className="flex items-center justify-between text-xs sm:text-sm font-mono">
                      <span className="text-neon-cyan/70 text-shimmer">
                        Play Count:
                      </span>
                      <span
                ...
                <div className="space-y-2 max-h-48 sm:max-h-64 overflow-y-auto">
                  {selectedPlaylist.tracks.map((track, index) => (
                    ...
                    >
                      ...
                      <p className="text-xs sm:text-sm text-gray-400 truncate text-shimmer">
                        {track.artist}
                      </p>
                    </div>
                  ))}
